                                        ...
                                        <tbody >
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p5t es-p5b">
                                              ...
                                              <p>
                                                <br>
                                                Thank you for your interest in our <b>{{jobRole}}</b> role at <b>{{companyName}}</b>. We have reviewed your application and although your background is impressive, we have made the decision to proceed forward with other candidates that are a stronger match for the role at this time.
                                              </p>
                                              <p>
